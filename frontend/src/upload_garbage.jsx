...
export default function UploadGarbage() {
  return (
    <div>
      ...
      <label htmlFor="file-upload-garbage" className="transition-all cursor-pointer rounded my-5 py-2 px-4 bg-emerald-600 hover:bg-emerald-700 hover:scale-110 active:bg-emerald-800 inline-flex inline-center">
