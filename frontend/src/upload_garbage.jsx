...
export default function UploadGarbage() {
  return (
    <div>
      ...
      <label for="file-upload-garbage" className="transition-all cursor-pointer rounded py-2 px-4 bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 inline-flex inline-center">
